            ...
            monthly: [

                {
                    ...
                    features: [
                        ...
                        {
                            feature_name: "1 Analytic Report",
                            status: 1
                        },
                ...
                <div key={index} className="p-6 space-y-8 transition-all duration-300 bg-gray-100 rounded-md shadow-lg hover:shadow-2xl max-w-max group">
                    <div className="flex space-x-10">
                        <div className="space-y-6">
                            ...
                            <p className="text-4xl font-semibold text-gray-900">{cat.prize} <span className="text-base font-normal text-gray-500"><br/>/ {cat.duration}</span></p>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {
                            cat.features.map((feature, sub_index)=>{
                                return(
                                    <div key={`#${sub_index}`} className="flex space-x-5">
                    ...
                    <div className="mx-auto max-w-max">
                        <button className="flex-grow-0 p-2 px-5 text-lg font-semibold text-white rounded-full shadow-md bg-gradient-to-r from-sky-700 to-rose-700">Book a demo</button>
                    </div>
        ...
        return(
            <div>
                <div className="p-20 space-y-5">
                    <p className="text-4xl font-semibold text-center text-blue-900">Easy pricing for your specific needs</p>
                    <p className="text-base font-semibold text-center text-gray-500">AI LAb ‘s platform is free for 15 days</p>
