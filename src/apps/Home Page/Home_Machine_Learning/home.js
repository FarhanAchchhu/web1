    ...
    render() {
        ...
        return (
            <div className="overflow-hidden">
                ...
                <div className="md:px-12 px-5 space-y-20 md:pt-40 overflow-hidden">
                    <div className="md:-ml-10 -ml-5 w-screen relative">
                                ...
                                <div className="md:flex items-center justify-center flex-grow-0 md:p-5 md:px-17">
                                    <div className="space-y-8 pt-10">
                                        <p className="text-4xl text-blue-900">
                                            Serving businesses by implementing
                                            AI
                                        </p>

                                        <p className="text-base text-black-500">
                                            Whatever your business nature,
                                            ordinary or difficult,we will be
                                            happy to serve you. Tell us your
                                            business plan and get assistance
                                            from our experts for Machine
                                            Learning Services and Artificial
                        ...
                        <img
                            ...
                            className="w-full transform rotate-180 left-0 hidden md:block absolute top-0"
                        />
                    </div>
                    {/* section 4 */}
                    <div className="md:flex">
                        <div className="flex items-center justify-center flex-grow-0 md:p-8 md:px-24">
                            <div className="space-y-8">
                                ...
                                <img
                                    alt=""
                                    src={ml_about_service}
                                    className="md:hidden"
                                />
                                <p className="text-base text-gray-500">
                                    What do you do when no one else is looking?
                                    Our teams act with integrity and honesty,
                                    and focus on putting ourselves in the shoes
                                    of others.
                                </p>
                                ...
                                <div className="flex  space-x-3">
                                    <div className="space-y-6">
                                        <div className="flex space-x-3">
                                            ...
                                            <p className="font-medium tracking-wide text-gray-800">
                                                ...
                                                futuristic solutions and
                                                services for invincible business
                                                growth.
                                            </p>
                                        </div>
                                        <div className="flex space-x-3">
                                            ...
                                            <p className="font-medium tracking-wide text-gray-800">
                                                To add 'unstoppable success' in
                                                small, middle and financial
                                    ...
                                    <div className=" space-y-6">
                                        ...
                                        <div className="flex space-x-3">
                                            ...
                                            <p className="font-medium tracking-wide text-gray-800">
                                                Seeding better tomorrow through
                                                today's technology.
                                            </p>
                                        </div>
                                    </div>
                ...
                {/* our skills */}
                <div className="md:flex md:space-x-8 md:pt-11 relative">
                    ...
                    <div className="flex-grow-0 flex-shrink md:w-1/2 md:p-16 md:pt-32 space-y-8 p-5">
                        ...
                        <p className="text-base text-gray-500">
                            We have pored over customer's input. We have fleshed
                            out your idea – and it’s taking real form! We know
                            it satisfied a real need in your market, and we have
                            decided We can build it. So what’s next?
                        </p>
