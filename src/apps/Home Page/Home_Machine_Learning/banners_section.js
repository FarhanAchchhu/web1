        ...
        return(
            <div className="">
                ...
                <div className=" bg-transparent w-full relative -z-10">
                    ...
                    <p className="text-4xl text-gray-700 tracking-wide font-semibold">AI & Machine Learning <br/>Products Creators</p>
                        <p className="text-md text-gray-700">We create everything that your enterprise needs from training data to working <br/> with unstructured text, images and videos for machine learning. <br/><br/>U-SMART.AI is a data driven consulting and product development company that empowers processes and decision making through human centric AI.</p>
