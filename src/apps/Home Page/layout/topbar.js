            ...
            <div className="md:hidden bg-white  w-full z-50">
                <div className="flex justify-center items-center p-3">
                    ...
                    <div className="flex max-w-max space-x-3">
                        <img alt="website_logo" src={website_logo} className="w-8" />
                    ...
                    <div className="flex justify-end items-end flex-grow space-x-6">
                        ...
                        <button onClick={openSidebar} className="outline-none focus:outline-none">
                            <img alt="menu_hamburger" src={menu_hamburger} className="w-6 h-6" />
                        </button>
                    </div>
                </div>

                {/* sidebar */}
                <div className={`bg-black ${sidebar_w} h-screen bg-opacity-75 overflow-hidden duration-300 transition-all  fixed top-0 z-50 left-0`}>
                    <div className={` bg-gray-900 h-screen bg-opacity-100 w-80 overflow-y-auto`}>
                        <div className="space-y-3 flex flex-col p-3">

                            <div className="flex pb-5 px-2">
                                <div className="flex space-x-3 flex-grow">
                                    <img alt="website_logo" src={website_logo} className="w-8" />
                                    <p className="text-xl text-gray-100 font-semibold my-auto">U-Smart.ai</p>
                                </div>

                                <button onClick={closeSidebar} className="mt-1"><img alt="close" src={close} className="w-5" /></button>
                            </div>

                            <div className={`space-y-3 ${cat_h}  overflow-hidden transition-all duration-300`}>
                                <p onClick={uncollapseCat} className="text-xl font-semibold text-white">Home</p>
