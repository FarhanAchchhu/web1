            ...
            <div className="relative -z-10 ">
                <div className="absolute left-0 w-full md:p-16 p-5 md:top-0 -top-3">
                    <div className="md:space-y-3 space-y-1 md:w-1/2">
                        <p className="md:text-6xl text-2xl  text-left font-semibold text-blue-900">Contact Us</p>
                        ...
                        <div className="flex ml-1 md:space-x-3 space-x-2">
                            ...
                            <a href="/contact-us" className="text-gray-500 md:text-sm text-xs">Contact Us</a>
                        </div>
                    </div>
                </div>
