    ...
    return (
      <div className="md:flex md:px-20 px-5">
        <div className="md:w-1/2 md:pt-40 md:p-10 md:space-y-6 space-y-3">
          ...
          <p>
            We Create The Most Realistic AI Enabled Humanise Interactions For
            Deeper Engagement.
            <br />
            <br />
            That All in Favour of Your Business.Creating decisions quickly along
            with data driven insight, we at ‘U-SMART’ add-on full-proof targets
            for the best business outcomes.
            <br />
            <br />
            Modification Of Buisness Outcomes With Analytics, our team attempt
            along ‘To be a revered solution company centred on innovative
            technologies, delivering world category quality huge knowledge
            solutions’.
          </p>
